...
public class PlayerIntroState : PlayerMovementState
{
    ...
    public PlayerIntroState(PlayerController player, BardentStateMachine<PlayerMovementState> movementStateMachine, string animationName) : base(player, movementStateMachine, animationName)
    {
