...
public class PlayerFallingState : PlayerJumpState
{
    ...
    public PlayerFallingState(PlayerController player, BardentStateMachine<PlayerMovementState> movementStateMachine, string animationName) : base(player, movementStateMachine, animationName)
    {
    }
