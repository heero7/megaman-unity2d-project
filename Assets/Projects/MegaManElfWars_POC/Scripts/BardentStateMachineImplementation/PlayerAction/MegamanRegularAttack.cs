...
public class MegamanRegularAttack : PlayerActionState
{
    ...
    public MegamanRegularAttack(PlayerController player, BardentStateMachine<PlayerActionState> actionStateMachine, BardentStateMachine<PlayerMovementState> movementStateMachine) : base(player, actionStateMachine, movementStateMachine)
    {
    }
