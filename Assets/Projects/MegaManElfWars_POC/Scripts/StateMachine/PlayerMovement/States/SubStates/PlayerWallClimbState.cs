...
public class PlayerWallClimbState : PlayerMovementState
{
    ...
    public PlayerWallClimbState(PlayerController player, StateMachine<PlayerMovementState> movementStateMachine, string animationName) : base(player, movementStateMachine, animationName)
    {
    }
